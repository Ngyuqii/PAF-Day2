...
import paf.firstpractice.model.Dependant;
...
public class EmployeeRepoImpl implements EmployeeRepo {
    ...
    public List<Employee> retrieveEmployeeList() {
        String selectSQL = "select e.id employee_id, e.first_name, e.last_name, e.salary, " +
                "d.id dependant_id, d.first_name, d.last_name, d.relationship, d.birth_date  " +
        ...
        return jdbcTemplate.query(selectSQL, new ResultSetExtractor<List<Employee>>() {
            ...
            public List<Employee> extractData(ResultSet rs) throws SQLException, DataAccessException {
                ...
                while (rs.next()) {
                    ...
                    emp.setDependant(new ArrayList<Dependant>());
                    ...
                    if (employees.size() == 0) {
                        ...
                        if (eList.size() == 0) {
                            ...
                            if (idx >= 0) {
                                employees.get(idx).getDependant().add(dep);
                            }
                        }
                    }
